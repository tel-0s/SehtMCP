...
public sealed class ExternalTools(SehtConfig config)
{
    public object Status() => new
    {
        ...
        liveEditorBridge = false, note = "This release authors plugin files with Mutagen. CK launch/status is available; live editor operations, navmesh generation, FaceGen, and lip generation require CK integration in a future release."
    };
