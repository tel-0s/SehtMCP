...
This is a working **0.1.0 developer release**, with tests and an installed-game smoke test. It is not a complete automation layer for every Creation Kit operation. CK integration currently includes executable detection, launch/status, plugin output, and the installed Papyrus compiler. Live CK editing, navmesh generation, FaceGen, landscape sculpting, and lip generation remain future work.
...
| MCP | Official C# SDK; 45 tools, resource, prompt, structured results, image content, tool annotations |
